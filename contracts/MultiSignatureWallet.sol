...
contract MultiSigWallet {
    ...
    // Execute a transaction if it has enough confirmations
    ...
    // Check if a transaction is confirmed by a specific owner
    ...
    // Get all pending transactions (not executed)
    function getPendingTransactions() 
        public 
        view 
        returns (uint256[] memory) 
    {
        uint256[] memory pendingTxs = new uint256[](transactions.length);
        uint256 count = 0;
